...
// Translocator Beacon
//=============================================================================
class UT2003TransBeacon extends TranslocatorBeacon;
...
function bool AimUp()
{
	...
	return xPlayer(Instigator.Controller).bClassicTrans;
}
...
State MonitoringThrow
{
	...
	{
		if ( UT2003TransLauncher(Instigator.Weapon) != None )
...
defaultproperties
{
     ...
     TransTrailClass=XEffects.TransTrail
     TransFlareClass=XEffects.TransFlareRed
     Speed=1200.000000
     DamageRadius=100.000000
     MomentumTransfer=50000.000000
     MyDamageType=XWeapons.DamTypeTeleFrag
     ...
     AmbientSound=WeaponSounds.Misc.redeemer_flight
