...
static function bool OverridePickupQuery(Pawn Other, Pickup item, out byte bAllowPickup, int AbilityLevel)
{
	...
	if (ClassIsChildOf(item.InventoryType, class'EnhancedRPGArtifact') || ClassIsChildOf(item.InventoryType, class'DruidArtifactLightningRod'))
	{
...
DefaultProperties
{
	  ...
	  Description="When you spawn:|Level 1: You are granted all regular weapons with the default percentage chance for magic weapons.|Level 2: You are granted onslaught weapons and all weapons with max ammo.|Level 3: You are granted super weapons (Invasion game types only).|Level 4: Magic weapons will be generated for all your weapons.|Level 5: You receive all positive magic weapons. Level 6 all maxed weapons and increased weapon damage, and reduced ability to use artifacts. |You must be level 40 before you can buy level 2 and level 55 before you can buy level 3.|Cost (per level): 10,15,20,25,30"
	  StartingCost=10
	  CostAddPerLevel=5
	  MaxLevel=6
